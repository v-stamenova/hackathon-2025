<div class='h-full'>
    <div class='h-full flex items-end pb-20 justify-center px-10'>
        <div class='grid grid-cols-1'>
            <div class='flex items-center justify-center'>
                <img src='/images/logo.png' class='h-13' alt=''/>
                <h1 class='text-sm font-bold'>X</h1>
                <img src='/images/futureu.png' class='h-13' alt=''/>
            </div>
